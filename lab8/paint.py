...
pygame.display.set_icon(pygame.image.load('lab8/icon.png'))
...
blue_image = pygame.image.load('lab8/blue.png').convert_alpha()
red_image = pygame.image.load('lab8/red.png').convert_alpha()
green_image = pygame.image.load('lab8/green.png').convert_alpha()
pink_image = pygame.image.load('lab8/pink.png').convert_alpha()
eraser_image = pygame.image.load('lab8/eraser.png').convert_alpha()
