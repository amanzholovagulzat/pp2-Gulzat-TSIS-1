...
pygame.display.set_icon(pygame.image.load('lab9/icon.png'))
...
blue_image = pygame.image.load('lab9/blue.png').convert_alpha()
red_image = pygame.image.load('lab9/red.png').convert_alpha()
green_image = pygame.image.load('lab9/green.png').convert_alpha()
pink_image = pygame.image.load('lab9/pink.png').convert_alpha()
eraser_image = pygame.image.load('lab9/eraser.png').convert_alpha()
