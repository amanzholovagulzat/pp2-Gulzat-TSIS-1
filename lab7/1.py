...
def main():
    ...
    # loading the images 
    clock_image = pygame.transform.scale(pygame.image.load('lab7/mickeyclock.jpeg'), (800, 600))
    sechand_image = pygame.image.load('lab7/sechand.png')
    sechand_image = pygame.transform.scale(sechand_image, (250, 75))
    sechand_rect = sechand_image.get_rect()
    sechand_rect.center = (400, 300)
    minhand_image = pygame.image.load('lab7/minhand.png')
